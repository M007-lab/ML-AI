This project presents the results of comparing Naive Bayes vesus Support Vectors Machine performances on Email classification. It builds both models from scratch without using external libraries.
